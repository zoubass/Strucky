...
public class SystemsList {
    ...
    private List<SystemApp> newlyCreated;
    ...
    private Integer generateUniqueSystemId() {
        log.error("Generating new Id for system. Please check the newly generated apps and fix values.");
    ...
    public List<SystemApp> getNewlyCreated() {
        return newlyCreated;
    }
